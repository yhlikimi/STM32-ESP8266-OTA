...
uint8_t dht11_init(void)
{
	...
	//设置DHT11 VCC引脚
	gpio_init_struct.Pin = DHT11_VCC_PIN;
	gpio_init_struct.Mode = GPIO_MODE_OUTPUT_PP;
	gpio_init_struct.Pull = GPIO_PULLUP;                  
	gpio_init_struct.Speed = GPIO_SPEED_FREQ_HIGH;        
    HAL_GPIO_Init(DHT11_VCC_PORT, &gpio_init_struct); 
	HAL_GPIO_WritePin(DHT11_VCC_PORT,DHT11_VCC_PIN,GPIO_PIN_SET);
	//设置DHT11 GND引脚
	gpio_init_struct.Pin = DHT11_GND_PIN;
	gpio_init_struct.Mode = GPIO_MODE_OUTPUT_PP;
	gpio_init_struct.Pull = GPIO_PULLDOWN; 
	gpio_init_struct.Speed = GPIO_SPEED_FREQ_HIGH; 
	HAL_GPIO_Init(DHT11_GND_PORT, &gpio_init_struct); 
	HAL_GPIO_WritePin(DHT11_GND_PORT,DHT11_GND_PIN,GPIO_PIN_RESET);
